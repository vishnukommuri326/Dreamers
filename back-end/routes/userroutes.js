...
const { validateUserSettings, handleValidationErrors } = require('../validators/userValidator');
...
router.put('/:username', validateUserSettings, handleValidationErrors, (req, res) => {
  const { username } = req.params;
